...
export const COMMANDS: CommandDoc[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      { flag: '--payouts <json>', description: 'the same payouts in full form, when a colon spec cannot say it (unlock): [{"address":..,"ada":..,"assets":[{"unit":..,"quantity":..}],"datum":..}]; a datum tells a validator which claim the payment settles' },
